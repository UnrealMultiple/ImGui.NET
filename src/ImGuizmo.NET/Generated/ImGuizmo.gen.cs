...
namespace ImGuizmoNET
{
    public static unsafe partial class ImGuizmo
    {
        ...
        public static void SetAlternativeWindow(ImGuiWindowClassPtr window)
        {
            ImGuiWindowClass* native_window = window.NativePtr;
            ImGuizmoNative.ImGuizmo_SetAlternativeWindow(native_window);
        }
